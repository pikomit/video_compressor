...
//
    ...
    private fun getBitrate(
        ...
        return when (quality) {
            VideoQuality.VERY_LOW -> (bitrate * 0.15).roundToInt()
            VideoQuality.LOW -> (bitrate * 0.30).roundToInt()
            VideoQuality.MEDIUM -> (bitrate * 0.45).roundToInt()
            VideoQuality.HIGH -> (bitrate * 0.60).roundToInt()
